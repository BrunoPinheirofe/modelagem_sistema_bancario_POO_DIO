...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        numero_saque = len(
            [transacao for transacao in self.historioco.trasacoes if transacao["tipo"] == Saque.__name__]
        )
...
class Historico:
    ...
    def adicionar_transacão(self, transacao):
...
class Deposito(Transacao):
    ...
    def registrar(self, conta):
        ...
        if sucesso_transacao:
            conta.hisorico.adicionar_transacao(self)
